...
- 产物文件示例：`docs/specs/资源访问审批与时效控制.md`。
...
- 产物文件示例：`docs/codemap/访问审批链路功能.md`。
...
- 产物文件示例：`docs/codemap/sample-enterprise项目总图.md`。
...
- 产物文件示例：`docs/context/资源访问审批与时效控制_context_bundle.md`。
...
```text
验证功能: log_path=./logs/release-test/, spec=docs/specs/资源访问审批与时效控制.md
```
...
```text
REVIEW SPEC: spec=docs/specs/资源访问审批与时效控制.md, scope=plan_only
```
...
```text
REVIEW EXECUTE: spec=docs/specs/资源访问审批与时效控制.md, scope=changed_only
```
...
```text
ARCHIVE: targets=[docs/specs/资源访问审批与时效控制.md,docs/codemap/访问审批链路功能.md], kind=mixed, audience=both, mode=snapshot, topic=访问审批时效化
```
...
- 生成双文档：
  - `docs/archive/访问审批时效化_human.md`
  - `docs/archive/访问审批时效化_llm.md`
