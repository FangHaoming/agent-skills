...
- 产物路径：`docs/codemap/<project_id>项目总图.md`
...
- 输出：
  - `feature`：`docs/codemap/<feature>功能.md`
  - `project`：`docs/codemap/<project>项目总图.md`
- 要点：
...
- 输出：`docs/context/<task>_context_bundle.md`
- 输出级别：
...
- 输出：
  - `human`：`docs/archive/<topic>_human.md`（汇报视角）
  - `llm`：`docs/archive/<topic>_llm.md`（后续开发参考视角）
...
- `create_codemap(feature)`：`docs/codemap/<feature>功能.md`
- `create_codemap(project)`：`docs/codemap/<project>项目总图.md`
- `build_context_bundle`：`docs/context/<task>_context_bundle.md`
- `sdd_bootstrap`：`docs/specs/<TaskName>.md`
- `archive(human)`：`docs/archive/<topic>_human.md`
- `archive(llm)`：`docs/archive/<topic>_llm.md`
